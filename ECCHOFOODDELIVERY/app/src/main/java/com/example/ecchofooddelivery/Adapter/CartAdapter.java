...
import com.example.ecchofooddelivery.Helper.ChangeNumberItemsListener;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.viewholder holder, int position) {
        ...
        holder.feeEachItem.setText("S/."+(list.get(position).getNumberIncart()*list.get(position).getPrice()));
        holder.totalEachItem.setText(list.get(position).getNumberIncart()+" * S/."+(
